...
Place the superpy folder in your C:\ drive (or adjust parent_dir in superpy.py and create_read.py)
py ./superpy.py -h
    You will then see a help screen with the features of this program
    Select one of the features, for example: py .\superpy.py buy -h
'''
